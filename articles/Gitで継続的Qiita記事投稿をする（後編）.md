...
記事では main 関数のみ抜粋します。
ソースコードは[リポジトリ](https://github.com/iwsh/qiita_articles/tree/main/.github/scripts)を参照してください
...
1. ワークフローが複雑化する
   - 一連の投稿処理の後に管理ファイルの更新のためリポジトリへの push が必要
   - push をトリガにまたワークフローが起動してしまうのでは？
...
多少の課題はあるものの、個人的には満足のいく仕組みを構築できました。
